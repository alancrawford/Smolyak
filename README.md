...
Chebyshev polynomials have many benefits over ordinary polynomials (i.e. low correlation of basis functions). However, they are not inherently sparse. This is unlikely to be costly in many applications. However, when sparsity is important the user might like to use spread polynomials. 
